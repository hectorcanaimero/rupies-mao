...
class ViewServicesWithCategoriesTable
    extends SupabaseTable<ViewServicesWithCategoriesRow> {
  @override
  String get tableName => 'view_services_with_categories';

  @override
  ViewServicesWithCategoriesRow createRow(Map<String, dynamic> data) =>
      ViewServicesWithCategoriesRow(data);
}

class ViewServicesWithCategoriesRow extends SupabaseDataRow {
  ViewServicesWithCategoriesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ViewServicesWithCategoriesTable();
