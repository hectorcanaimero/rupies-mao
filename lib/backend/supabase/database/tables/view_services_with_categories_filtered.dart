...
class ViewServicesWithCategoriesFilteredTable
    extends SupabaseTable<ViewServicesWithCategoriesFilteredRow> {
  @override
  String get tableName => 'view_services_with_categories_filtered';

  @override
  ViewServicesWithCategoriesFilteredRow createRow(Map<String, dynamic> data) =>
      ViewServicesWithCategoriesFilteredRow(data);
}

class ViewServicesWithCategoriesFilteredRow extends SupabaseDataRow {
  ViewServicesWithCategoriesFilteredRow(Map<String, dynamic> data)
      : super(data);

  @override
  SupabaseTable get table => ViewServicesWithCategoriesFilteredTable();
