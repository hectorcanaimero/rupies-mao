...
import 'sac_page_model.dart';
export 'sac_page_model.dart';
...
class _SacPageWidgetState extends State<SacPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SacPageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'SacPage'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SAC_arrow_back_rounded_ICN_ON_TAP');
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Como podemos te ajudar hoje? Escolha uma opção e envie sua mensagem.',
                      ...
                      Align(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent('SAC_ENVIAR_SOLICITAO_BTN_ON_TAP');
                            logFirebaseEvent('Button_backend_call');
                            _model.userCreate = await SacsTable().insert({
                              'user': currentUserUid,
                              'type': _model.radioButtonValue,
                              'message': _model.messageFieldTextController.text,
                            });
                            if (_model.radioButtonValue == 'Suporte Técnico') {
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Show!'),
                                    content: Text(
                                        '👋 Recebemos seu pedido. Vamos processar em até 24 horas e te avisaremos por e-mail.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                                            Navigator.pop(alertDialogContext),
