    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case MessageCommentRow:
            return MessageCommentRow(data);
          case LeadAttachmentRow:
            return LeadAttachmentRow(data);
          case ViewServiceRatingRow:
            return ViewServiceRatingRow(data);
          case SubscriptionsRow:
            return SubscriptionsRow(data);
          case LeadsRow:
            return LeadsRow(data);
          case ViewProvidersRow:
            return ViewProvidersRow(data);
          case ViewUsersSkillWithCategoriesRow:
          ...
          case UsersPortfolioRow:
            return UsersPortfolioRow(data);
          case ServicesRatingRow:
            return ServicesRatingRow(data);
          case ServicesCandidatedRow:
            return ServicesCandidatedRow(data);
          case TypeProviderRow:
            return TypeProviderRow(data);
          case UsersSkillRow:
          ...
          case ViewServicesCandidatedUsersRow:
            return ViewServicesCandidatedUsersRow(data);
          case LeadContactRow:
            return LeadContactRow(data);
          default:
            return null;
        }
