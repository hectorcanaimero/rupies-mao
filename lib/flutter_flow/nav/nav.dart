...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ReservationsPageWidget.routeName,
          path: ReservationsPageWidget.routePath,
          builder: (context, params) => ReservationsPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ServiceCandidatedPageWidget.routeName,
          path: ServiceCandidatedPageWidget.routePath,
          builder: (context, params) => ServiceCandidatedPageWidget(
            id: params.getParam(
              'id',
              ParamType.String,
            ),
            service: params.getParam<ViewServicesWithCategoriesRow>(
              'service',
        ...
        FFRoute(
          name: AvaliacoesPageWidget.routeName,
          path: AvaliacoesPageWidget.routePath,
          builder: (context, params) => AvaliacoesPageWidget(),
        ),
        FFRoute(
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/images/Avatar_ModeObra_Loja_APP.jpg',
                          width: 240.0,
                          fit: BoxFit.cover,
                        ),
                      ),
